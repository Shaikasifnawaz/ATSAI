    ...
    def process_pdf(self, file_name, pdf_file):
        try:
            ...
            if existing_record:
                ...
                # Insert or update details in the new collection
                ...
                # Insert details in the new collection
                self.details_collection.insert_one({
                    "file_name": file_name,
                    "name": details["name"],
                    "email": details["email"],
                    "skills": details["skills"]
...
processor = PDFProcessor(MONGO_URI, db_name)
...
def ai_resume_upload_query():
    try:
        ...
        pdf_processor = PDFProcessor(MONGO_URI, db_name)
